...
const thumbVariants = cva(
  "h-5 w-5 bg-background relative rounded-full block ease-out transition-all duration-350 border-1 border-highlight  after:absolute after:top-1/2 after:left-1/2 after:-translate-1/2 after:bg-muted-foreground after:rounded-full shadow-inset translate-x-0 data-[checked]:translate-x-6.5 data-[checked]:after:bg-primary ",
);
